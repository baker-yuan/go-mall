...
type Subject struct {
	...
	ProductCount    uint32 `protobuf:"varint,5,opt,name=product_count,json=productCount,proto3" json:"product_count,omitempty"`          // 关联产品数量
	RecommendStatus uint32 `protobuf:"varint,6,opt,name=recommend_status,json=recommendStatus,proto3" json:"recommend_status,omitempty"` // 推荐状态
	CreateTime      uint32 `protobuf:"varint,7,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                // 创建时间
	CollectCount    uint32 `protobuf:"varint,8,opt,name=collect_count,json=collectCount,proto3" json:"collect_count,omitempty"`          // 收藏数量
	ReadCount       uint32 `protobuf:"varint,9,opt,name=read_count,json=readCount,proto3" json:"read_count,omitempty"`                   // 阅读数量
	CommentCount    uint32 `protobuf:"varint,10,opt,name=comment_count,json=commentCount,proto3" json:"comment_count,omitempty"`         // 评论数量
	AlbumPics       string `protobuf:"bytes,11,opt,name=album_pics,json=albumPics,proto3" json:"album_pics,omitempty"`                   // 画册图片，用逗号分割
	Description     string `protobuf:"bytes,12,opt,name=description,proto3" json:"description,omitempty"`                                // 描述
	ShowStatus      uint32 `protobuf:"varint,13,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"`               // 显示状态：0->不显示；1->显示
	Content         string `protobuf:"bytes,14,opt,name=content,proto3" json:"content,omitempty"`                                        // 内容
	ForwardCount    uint32 `protobuf:"varint,15,opt,name=forward_count,json=forwardCount,proto3" json:"forward_count,omitempty"`         // 转发数
...
var file_model_cms_subject_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x70, 0x69, 0x63, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x65,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x53,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	...
	0x65, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x62, 0x75, 0x6d, 0x5f, 0x70, 0x69, 0x63, 0x73, 0x18, 0x0b, 0x20,
	...
	0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x0e, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x66,
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0c, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74,
