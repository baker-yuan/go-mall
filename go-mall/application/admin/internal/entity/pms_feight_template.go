...
type FeightTemplate struct {
	...
	FirstWeight    float64 `gorm:"column:first_weight;type:decimal(10,2);not null;default:0.00;comment:首重kg"`
	FirstFee       float64 `gorm:"column:first_fee;type:decimal(10,2);not null;default:0.00;comment:首费（元）"`
	ContinueWeight float64 `gorm:"column:continue_weight;type:decimal(10,2);not null;default:0.00;comment:续重kg"`
	ContinmeFee    float64 `gorm:"column:continme_fee;type:decimal(10,2);not null;default:0.00;comment:续费（元）"`
