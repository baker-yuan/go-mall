...
type Product struct {
	...
	ProductCategoryID          uint64  `gorm:"column:product_category_id;type:bigint;unsigned;not null;default:0;comment:品牌分类id"` // pms_product_category#id
	...
	Price                      float64 `gorm:"column:price;type:decimal(10,2);not null;default:0.00;comment:价格"`
	PromotionPrice             float64 `gorm:"column:promotion_price;type:decimal(10,2);not null;default:0.00;comment:促销价格"`
	...
	OriginalPrice              float64 `gorm:"column:original_price;type:decimal(10,2);not null;default:0.00;comment:市场价"`
	...
	Weight                     float64 `gorm:"column:weight;type:decimal(10,2);not null;default:0.00;comment:商品重量，默认为克"`
	...
	DetailHTML                 string  `gorm:"column:detail_html;type:text;not null;comment:产品详情网页内容"`
	DetailMobileHTML           string  `gorm:"column:detail_mobile_html;type:text;not null;comment:移动端网页详情"`
