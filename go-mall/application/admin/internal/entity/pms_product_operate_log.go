...
type ProductOperateLog struct {
	...
	PriceOld         float64 `gorm:"column:price_old;type:decimal(10,2);not null;default:0.00;comment:改变前价格"`
	PriceNew         float64 `gorm:"column:price_new;type:decimal(10,2);not null;default:0.00;comment:改变后价格"`
	SalePriceOld     float64 `gorm:"column:sale_price_old;type:decimal(10,2);not null;default:0.00;comment:改变前优惠价"`
	SalePriceNew     float64 `gorm:"column:sale_price_new;type:decimal(10,2);not null;default:0.00;comment:改变后优惠价"`
