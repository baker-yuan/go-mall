...
type OrderReturnApply struct {
	...
	ProductRealPrice float64 `gorm:"column:product_real_price;type:decimal(10,2);not null;default:0.00;comment:商品实际支付单价"`
	...
	ProductPrice     float64 `gorm:"column:product_price;type:decimal(10,2);not null;default:0.00;comment:商品单价"`
	//
