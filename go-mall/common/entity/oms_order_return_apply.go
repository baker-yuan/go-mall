...
type OrderReturnApply struct {
	...
	ProductRealPrice string `gorm:"column:product_real_price;type:decimal(10,2);not null;default:0.00;comment:商品实际支付单价"`
	...
	ProductPrice     string `gorm:"column:product_price;type:decimal(10,2);not null;default:0.00;comment:商品单价"`
	//
	...
	//
	ReturnAmount     string `gorm:"column:return_amount;type:decimal(10,2);not null;default:0.00;comment:退款金额"`
