...
type FeightTemplate struct {
	...
	FirstWeight    string `gorm:"column:first_weight;type:decimal(10,2);not null;default:0.00;comment:首重kg"`
	FirstFee       string `gorm:"column:first_fee;type:decimal(10,2);not null;default:0.00;comment:首费（元）"`
	ContinueWeight string `gorm:"column:continue_weight;type:decimal(10,2);not null;default:0.00;comment:续重kg"`
	ContinmeFee    string `gorm:"column:continme_fee;type:decimal(10,2);not null;default:0.00;comment:续费（元）"`
