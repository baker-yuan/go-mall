...
type Coupon struct {
	...
	Amount string `gorm:"column:amount;type:decimal(10,2);not null;default:0.00;comment:金额"`
	...
	MinPoint    string `gorm:"column:min_point;type:decimal(10,2);not null;default:0.00;comment:使用门槛；0表示无门槛"`
