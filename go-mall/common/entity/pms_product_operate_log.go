...
type ProductOperateLog struct {
	...
	PriceOld         string `gorm:"column:price_old;type:decimal(10,2);not null;default:0.00;comment:改变前价格"`
	PriceNew         string `gorm:"column:price_new;type:decimal(10,2);not null;default:0.00;comment:改变后价格"`
	SalePriceOld     string `gorm:"column:sale_price_old;type:decimal(10,2);not null;default:0.00;comment:改变前优惠价"`
	SalePriceNew     string `gorm:"column:sale_price_new;type:decimal(10,2);not null;default:0.00;comment:改变后优惠价"`
