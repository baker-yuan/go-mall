...
type ProductLadder struct {
	...
	Discount  float64 `gorm:"column:discount;type:decimal(10,2);not null;default:0.00;comment:折扣"`
	Price     float64 `gorm:"column:price;type:decimal(10,2);not null;default:0.00;comment:折后价格"`
	// 公共字段
	BaseTime
}
