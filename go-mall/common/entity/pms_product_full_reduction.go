...
type ProductFullReduction struct {
	...
	FullPrice   float64 `gorm:"column:full_price;type:decimal(10,2);not null;default:0.00;comment:商品满足金额"`
	ReducePrice float64 `gorm:"column:reduce_price;type:decimal(10,2);not null;default:0.00;comment:商品减少金额"`
	// 公共字段
	BaseTime
}
